...
describe 'As a User' do
	describe 'when I visit the shelters pets page' do
		before :each do
			...
			@ozzy = @aps.pets.create!(image: "https://www.insidedogsworld.com/wp-content/uploads/2017/06/German-Shepherd-Standard-Coat-GSC-1000x575-1-1-1-1.jpg", name: "Ozzy Paws Born", description: "German Shepard", age: 4, sex: "Male", adoptable: true)
		...
		it 'I expect to see all the pets ordered in the status of adoptable first' do
			...
			expect(@aps.pets.last).to eq(@cricket)
		end
	end
end
