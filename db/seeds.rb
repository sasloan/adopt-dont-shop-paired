...
@athena = @mikes.pets.create!(name: "Athena", description: "butthead", approximate_age: 1, sex: "Female")
@odell = @megs.pets.create!(name: "Odell", description: "good dog", approximate_age: 4, sex: "Male")
